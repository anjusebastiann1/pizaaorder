...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Pizza </a></li>
...
<h2 class="text-center"> Thank you for Ordering at Pizza World! Your Favourite Pizza is Getting Ready</h2>
