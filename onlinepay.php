...
<!--          <p class="text-center">Enter your Online payment details below.</p>-->
        </div>
    </div>
    <div class="row">
        <h1 class="text-center">Enter Your Online Payment Details Here....</h1>
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="carousel">
              <div class="row">
              <h1 class="text-center">For COD Click Here....</h1>
              <div class="row ">
                  <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                      <a href="order.php"><input type="submit" class="btn btn-danger btn-block" value="CANCEL" required="" /></a>
                  </div>
