...
<html>
  ...
  <head>
    <title> Explore |Pizza World </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="index.php"><span class="glyphicon glyphicon-cutlery"></span> Pizza </a></li>
...
//$conn = Connect();
//
//$sql = "SELECT * FROM pizza WHERE options = 'ENABLE' ORDER BY id";
