...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?<?=date("His")?>">
            ...
            $("#order").on("submit", function(e){
                ...
                $.ajax({
                    ...
                    success: function(ret){
                        ...
                        //     $("#action-status").html("You have successfully placed your order with Order Number: " +  + ". Please wait for our staff to call you for confirmation. Thank you.");
                        //
                        // }
...
<div>
    ...
    <form id="order" action="onlinepay.php">
